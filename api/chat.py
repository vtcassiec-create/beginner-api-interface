...
PRICING = {
    ...
    # Opus 5.5 (Sep 2026): 4/20 list. Its published cache rates run lower
    # than the derived 2x / 0.10x below; we keep the derived formula so the
    # bar reads a hair high rather than under the bill.
...
KEEP_PHOTO_TOOL = {
    ...
    "description": (
        ...
        "stays). It frames ANY image in the conversation, not only photos of "
        "her life — if she makes a picture from your description elsewhere (a "
        "portrait of you, a room, the way a scene looked in your head) and "
        "pastes it here, this is how YOU hang it on the wall, in your own "
        "words, instead of it being something she framed for you. By default "
        "this frames the MOST RECENT photo; set "
